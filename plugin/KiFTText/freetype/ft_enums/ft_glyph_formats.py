...
ft_glyph_format_none      = FT_GLYPH_FORMATS.FT_GLYPH_FORMAT_NONE
ft_glyph_format_composite = FT_GLYPH_FORMATS.FT_GLYPH_FORMAT_COMPOSITE
ft_glyph_format_bitmap    = FT_GLYPH_FORMATS.FT_GLYPH_FORMAT_BITMAP
ft_glyph_format_outline   = FT_GLYPH_FORMATS.FT_GLYPH_FORMAT_OUTLINE
ft_glyph_format_plotter   = FT_GLYPH_FORMATS.FT_GLYPH_FORMAT_PLOTTER
